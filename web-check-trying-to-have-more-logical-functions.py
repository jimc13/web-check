...
def create_table(table_name, url, str_paramaters, int_paramaters):
    """
    Creates a table in the format <id> <url> <things to be used in checks>
    <failed_connections> <max_failed_connections> <check_frequency>
    pass '' if you have no int_paramaters
    """
    class table_name(Base):
        ...
        params = ''
        for param in str_paramaters:
            param = Column(String)
            params += 'self.{}, '.format(param)

        for param in int_paramaters:
